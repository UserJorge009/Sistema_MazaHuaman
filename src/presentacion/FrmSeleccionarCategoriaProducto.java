 ...
 * @author jcarlosad7
 */
public class FrmSeleccionarCategoriaProducto extends javax.swing.JDialog {

    private FrmProducto vista;
    private final CategoriaControl CONTROL;
    private Categoria obj;
    
    public FrmSeleccionarCategoriaProducto(java.awt.Frame parent,FrmProducto vista, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(tabGeneral, javax.swing.GroupLayout.DEFAULT_SIZE, 751, Short.MAX_VALUE)
        );
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        if (tablaListado.getSelectedRowCount()==1){
            ...
            this.vista.txtCategoriaId.setText(id);
            this.vista.txtCategoriaNombre.setText(nombre);
            this.setVisible(false);
        }else{
            JOptionPane.showMessageDialog(this, "Seleccione una categoría para agregar","Sistema",JOptionPane.ERROR_MESSAGE);
        }
